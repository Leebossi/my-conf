...
Options.config.args.atlasloot = {
	...
	args = {
		...
		showContentPhaseInTT = {
			...
			get = function(info) return AtlasLoot.db.ContentPhases.enableTT end,
			set = function(info, value) AtlasLoot.db.ContentPhases.enableTT = value end,
		},
		enableContentPhaseOnLootTable = {
			...
			get = function(info) return AtlasLoot.db.ContentPhases.enableOnLootTable end,
			set = function(info, value) AtlasLoot.db.ContentPhases.enableOnLootTable = value AtlasLoot.GUI.OnLevelRangeRefresh() end,
		},
		enableContentPhaseOnItems = {
			...
			get = function(info) return AtlasLoot.db.ContentPhases.enableOnItems end,
			set = function(info, value) AtlasLoot.db.ContentPhases.enableOnItems = value UpdateItemFrame() end,
		},
		enableContentPhaseOnCrafting = {
			...
			get = function(info) return AtlasLoot.db.ContentPhases.enableOnCrafting end,
			set = function(info, value) AtlasLoot.db.ContentPhases.enableOnCrafting = value UpdateItemFrame() end,
		},
		enableContentPhaseOnSets = {
			...
			get = function(info) return AtlasLoot.db.ContentPhases.enableOnSets end,
			set = function(info, value) AtlasLoot.db.ContentPhases.enableOnSets = value UpdateItemFrame() end,
		},
	},
}
